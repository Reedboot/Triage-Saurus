...
This script is intended to turn a quick, stdlib-only scan (Skills/scan_repo_quick.py)
...
Usage examples
  # Single repo
  python3 Skills/generate_repo_findings.py /abs/path/to/repo

  # Expand a simple pattern under a repo root
  python3 Skills/generate_repo_findings.py --repos-root /mnt/c/Repos --pattern 'terraform-*' --update-knowledge
"""
