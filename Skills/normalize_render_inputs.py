...
Usage:
  python3 Skills/normalize_render_inputs.py --path Output/Audit/RenderInputs --in-place
  python3 Skills/normalize_render_inputs.py --path Output/Audit/RenderInputs --dry-run
"""
