...
This complements Skills/validate_findings.py by checking Mermaid fenced blocks.

Usage:
  python3 Skills/validate_markdown.py
  python3 Skills/validate_markdown.py --fix
  python3 Skills/validate_markdown.py --path Output/Findings/Repo/Repo_foo.md
"""
