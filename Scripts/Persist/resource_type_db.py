...
_FALLBACK: dict[str, dict] = {
    ...
    "azurerm_virtual_machine_scale_set":          {"friendly_name": "Virtual Machine Scale Set","category": "Compute",     "icon": "🖥️"},
    "azurerm_image":                              {"friendly_name": "VM Image",                "category": "Compute",     "icon": "🖼️"},
    # Azure — AI / Foundry
    "azurerm_cognitive_services":                 {"friendly_name": "AI Services",             "category": "Compute",     "icon": "🤖"},
    "azurerm_applied_ai_services":                {"friendly_name": "Applied AI Services",      "category": "Compute",     "icon": "🤖"},
    "azurerm_ai_studio":                          {"friendly_name": "AI Studio",               "category": "Compute",     "icon": "🤖"},
    "azurerm_machine_learning":                   {"friendly_name": "Machine Learning Workspace","category": "Compute",    "icon": "🤖"},
    "azurerm_openai":                             {"friendly_name": "Azure OpenAI",             "category": "Compute",     "icon": "🤖"},
    # Azure — Container
    ...
    "azurerm_managed_service_fabric":             {"friendly_name": "Managed Service Fabric",   "category": "Container",   "icon": "🧩", "display_on_architecture_chart": True},
    "azurerm_service_fabric_cluster":             {"friendly_name": "Service Fabric Cluster",   "category": "Container",   "icon": "🧩", "display_on_architecture_chart": True},
    "azurerm_service_fabric_clusters":            {"friendly_name": "Service Fabric Clusters",  "category": "Container",   "icon": "🧩", "display_on_architecture_chart": True},
    "azurerm_service_fabric_managed_cluster":     {"friendly_name": "Service Fabric Managed Cluster", "category": "Container", "icon": "🧩", "display_on_architecture_chart": True},
    ...
    "azurerm_route_table":                        {"friendly_name": "Route Table",              "category": "Network",     "icon": "🛣️"},
    "azurerm_bastion_host":                       {"friendly_name": "Bastion Host",             "category": "Network",     "icon": "🛡️"},
    "azurerm_cdn_profile":                        {"friendly_name": "Front Door / CDN Profile", "category": "Network",     "icon": "🌐"},
    "azurerm_cdn_frontdoor_endpoint":             {"friendly_name": "Front Door Endpoint",      "category": "Network",     "icon": "🌐", "display_on_architecture_chart": True, "parent_type": "azurerm_cdn_profile"},
    ...
    "azurerm_private_dns_zone":                   {"friendly_name": "Private DNS Zone",         "category": "Network",     "icon": "🧭"},
    "azurerm_private_dns_zone_virtual_network_link":{"friendly_name": "Private DNS VNet Link","category": "Network",     "icon": "🔗", "display_on_architecture_chart": False, "parent_type": "azurerm_private_dns_zone"},
    "azurerm_network_interface_security_group_association":{"friendly_name": "NIC Security Group Association","category": "Security","icon": "🔗","display_on_architecture_chart": False, "parent_type": "azurerm_network_security_group"},
    ...
    "azurerm_monitor_activity_log_alert":         {"friendly_name": "Activity Log Alert",       "category": "Monitoring",  "icon": "🔔"},
    ...
    "azurerm_app_service_certificate":            {"friendly_name": "App Service Certificate",  "category": "Security",    "icon": "🔐"},
    "azurerm_app_service_certificate_order":      {"friendly_name": "App Service Certificate Order", "category": "Security", "icon": "🔐"},
    # Azure — Messaging
    "azurerm_servicebus_namespace":               {"friendly_name": "Service Bus Namespace",    "category": "Messaging",   "icon": "📦"},
    "azurerm_servicebus_queue":                   {"friendly_name": "Service Bus Queue",        "category": "Messaging",   "icon": "📨", "display_on_architecture_chart": True, "parent_type": "azurerm_servicebus_namespace"},
    "azurerm_servicebus_topic":                   {"friendly_name": "Service Bus Topic",        "category": "Messaging",   "icon": "📢", "display_on_architecture_chart": True, "parent_type": "azurerm_servicebus_namespace"},
    "azurerm_servicebus_subscription":            {"friendly_name": "Service Bus Subscription", "category": "Messaging",   "icon": "📬", "display_on_architecture_chart": True, "parent_type": "azurerm_servicebus_topic"},
    "azurerm_eventhub_namespace":                 {"friendly_name": "Event Hub Namespace",      "category": "Messaging",   "icon": "📦"},
    "azurerm_eventhub":                           {"friendly_name": "Event Hub",                "category": "Messaging",   "icon": "📡", "display_on_architecture_chart": True, "parent_type": "azurerm_eventhub_namespace"},
    "azurerm_eventhub_consumer_group":            {"friendly_name": "Event Hub Consumer Group", "category": "Messaging",   "icon": "👥", "display_on_architecture_chart": True, "parent_type": "azurerm_eventhub"},
    ...
    "alicloud_ram_role_attachment":               {"friendly_name": "RAM Role Attachment",      "category": "Identity",    "icon": "🔗",  "display_on_architecture_chart": False, "parent_type": "alicloud_ram_role"},
    "alicloud_ram_role_policy_attachment":        {"friendly_name": "RAM Role Policy Attachment","category": "Identity",   "icon": "🔗",  "display_on_architecture_chart": False, "parent_type": "alicloud_ram_role"},
    ...
    "aws_s3_bucket_cors_configuration":           {"friendly_name": "S3 CORS Config",           "category": "Storage",     "icon": "⚙️", "display_on_architecture_chart": False, "parent_type": "aws_s3_bucket"},
    ...
    "aws_api_gateway_method_response":            {"friendly_name": "API Method Response",      "category": "API",         "icon": "🔌", "display_on_architecture_chart": False, "parent_type": "aws_api_gateway_method"},
    "aws_api_gateway_integration_response":       {"friendly_name": "API Integration Response", "category": "API",        "icon": "🎯", "display_on_architecture_chart": False, "parent_type": "aws_api_gateway_integration"},
    ...
    "aws_secretsmanager_secret":                  {"friendly_name": "Secrets Manager Secret",   "category": "Security",    "icon": "🤫", "display_on_architecture_chart": True,  "parent_type": "aws_kms_key"},
    "aws_secretsmanager_secret_version":          {"friendly_name": "Secret Version",           "category": "Security",    "icon": "🔐", "display_on_architecture_chart": False, "parent_type": "aws_secretsmanager_secret"},
    "aws_secretsmanager_secret_policy":           {"friendly_name": "Secret Policy",            "category": "Security",    "icon": "📜", "display_on_architecture_chart": False, "parent_type": "aws_secretsmanager_secret"},
    "aws_secretsmanager_secret_rotation":         {"friendly_name": "Secret Rotation",          "category": "Security",    "icon": "🔄", "display_on_architecture_chart": False, "parent_type": "aws_secretsmanager_secret"},
    ...
    "google_compute_disk":                        {"friendly_name": "Compute Disk",             "category": "Storage",     "icon": "💾", "display_on_architecture_chart": False, "parent_type": "google_compute_instance"},
    ...
    "google_secret_manager_secret":               {"friendly_name": "Secret Manager Secret",    "category": "Security",    "icon": "🤫", "display_on_architecture_chart": True, "parent_type": "google_kms_crypto_key"},
    "google_secret_manager_secret_version":       {"friendly_name": "Secret Version",           "category": "Security",    "icon": "🔐", "display_on_architecture_chart": False, "parent_type": "google_secret_manager_secret"},
...
_AZURE_ARM_ALIASES: dict[str, str] = {
    ...
    "microsoft.machinelearningservices/workspaces": "azurerm_machine_learning",
