...
AZURE_RESOURCE_TYPE_TO_ICON = {
    ...
    'azurerm_app_gateway_backend_pool': ('networking', 'app-gateway-backend-pool'),
    'azurerm_app_gateway_listener_http': ('networking', 'app-gateway-listener-http'),
    'azurerm_app_gateway_listener_https': ('networking', 'app-gateway-listener-https'),
    'azurerm_app_insights': ('monitor', 'app-insights'),
    'azurerm_app_registration': ('other', 'app-registration'),
    'azurerm_app_service': ('app_services', 'app-service'),
    ...
    'azurerm_cdn': ('web', 'cdn'),
    'azurerm_cdn_frontdoor_endpoint': ('networking', 'front-door-and-cdn-profiles'),
    ...
    'azurerm_eventgrid_topic': ('integration', 'event-grid'),
    ...
    'azurerm_kusto_cluster': ('databases', 'data-explorer-clusters'),
    ...
    'azurerm_nat_gateway': ('networking', 'nat-gateway'),
    'azurerm_nat_gateway_public_ip_association': ('networking', 'nat-gateway'),
    ...
    'azurerm_private_dns_zone': ('networking', 'private-dns'),
    'azurerm_private_dns_zone_virtual_network_link': ('networking', 'private-dns'),
    ...
    'azurerm_route_table': ('networking', 'route-tables'),
    'azurerm_route_tables': ('networking', 'route-tables'),
    'azurerm_route': ('networking', 'route-tables'),
    'azurerm_subnet_route_table_association': ('networking', 'route-tables'),
    'azurerm_network_interface_route_table_association': ('networking', 'route-tables'),
    ...
    'azurerm_service_fabric_cluster': ('containers', 'service-fabric-clusters'),
    'azurerm_service_fabric_clusters': ('containers', 'service-fabric-clusters'),
    'azurerm_service_fabric_managed_cluster': ('compute', 'service-fabric-clusters'),
    ...
    'azurerm_network_security_rule': ('networking', 'nsg'),
    'azurerm_subnet_network_security_group_association': ('networking', 'nsg'),
    'azurerm_subnet_nat_gateway_association': ('networking', 'nat-gateway'),
    ...
    'azurerm_virtual_network_peering': ('networking', 'vnet-peering'),
...
GCP_RESOURCE_TYPE_TO_ICON = {
    ...
    'google_compute_firewall':           ('Security_Command_Center', 'securitycommandcenter'),
    ...
    'google_storage_bucket_iam_binding': ('Security_Command_Center', 'securitycommandcenter'),
